...
const az: Dictionary = {
  ...
  aboutPage: {
    ...
    mission: {
      label: "Missiya",
      heading: "Son illər iqtisadiyyatın qeyri-neft sektorunun inkişafı üçün dövlət tərəfindən səmərəli tədbirlər həyata keçirilib, xüsusilə",
      text: "kənd təsərrüfatı üçün əlverişli şərait yaradılıb. Biz ölkəmizdə ərzaq təhlükəsizliyinin təmin olunmasına öz töhfəmizi vermək istəyirik. Fəaliyyətimizin məqsədi həm ölkəmizdə, həm də xaricdə ən tələbkar müştəriləri qane edə biləcək yüksək keyfiyyətli, ekoloji cəhətdən təmiz məhsullar yetişdirməkdir.",
    },
    greenhouse: {
      label: "İstixana",
      heading: "İstixanamızı qurmaq üçün bu sənayedə iki aparıcı Avropa şirkəti seçildi: Fransanın «RICHEL» və Hollandiyanın «STOLZE».",
      details: "60 illik təcrübəyə malik olan «RICHEL» şirkəti bizə Richel 12.8 istixanaları üçün ən son tikinti modellərindən birini təklif etdi, hündürlüyü 11 metrə qədər olan «silsilədə» və aralıqlar arasında 12.8 metr məsafə. Bu, həm soyuq, həm isti, həm də quraq bölgələrdə həcm və performans arasında ən yaxşı kompromisdir. Qalan avadanlıqlar 50 ildən artıqdır ki, hər bir sifarişin fərdi xüsusiyyətlərini nəzərə alaraq istixana avadanlığının layihələndirilməsi üçün ən yaxşı mühəndis həllərini təqdim edən «STOLZE» şirkəti tərəfindən təchiz edilmişdir.\nSuvarma, isitmə və ventilyasiya prosesləri «PRIVA» avtomatik sistemindən istifadə etməklə həyata keçirilir. Aqronomlara yalnız proqramın ciddi şəkildə əməl edəcəyi effektiv strategiya seçmək lazımdır. Bu, gün ərzində bitkilərimiz üçün ideal böyümə şəraiti yaratmağa və məhsul məhsuldarlığını əhəmiyyətli dərəcədə artırmağa kömək edir.",
      richel: "RICHEL",
      stolze: "STOLZE",
      priva: "PRIVA",
    },
    products: {
      label: "Məhsullar",
      heading: "Hazırda bir neçə növ pomidor yetişdiririk.",
      text: "Bunlar üzümdəki pomidorlar, çəhrayı pomidorlar, gavalı pomidorları və hər kəsin sevimli «albalı pomidorları»dır. Onların hamısı bazarda özünü çox yaxşı sübut edib və müştərilər tərəfindən bəyənilib. Baxmayaraq ki, hazırda ixrac məhsullarımızın əsasını üzümdə olan pomidor təşkil edir, gələcəkdə istixana təsərrüfatının ərazisi artdıqca, müştərilərimizin istəyinə uyğun olaraq, ixrac həcmində digər pomidor növlərini də təmin edə biləcəyik.",
      cards: [
        { name: "Budaqda pomidor" },
        { name: "Çəhrayı pomidor" },
        { name: "Gavalı pomidor" },
        { name: "Albalı pomidorları" },
      ],
    },
    experts: {
      label: "Ekspertlər",
      heading: "Bitkilərimiz ciddi nəzarət altındadır",
      text: "Aqronomlarımız çoxillik təcrübəyə malikdir və hər il Hollandiya, İspaniya və digər Avropa ölkələrində təlim keçirlər. Eyni zamanda, ildə bir neçə dəfə biz aparıcı holland mütəxəssisləri monitorinq və konsaltinq dəstəyi üçün dəvət edirik. Bütün bu tədbirlər ən tələbkar müştərilərimizin istəklərini təmin etmək məqsədi daşıyır.",
    },
  },
  contactsPage: {
