  ...
  return (
    <section className="relative h-[clamp(530px,52.7vw,1011px)] overflow-hidden max-lg:h-[530px] max-md:h-[560px]">
      ...
      <div className="relative mx-auto w-full max-w-[1920px] px-20 pt-[15.5vw] text-center max-lg:px-5 max-lg:max-w-[768px] max-lg:pt-[156px] max-md:px-[10px] max-md:max-w-[340px] max-md:pt-[86px]">
        ...
        <div className="-mt-[0.3vw] mx-auto flex w-[clamp(12.5rem,22vw,25rem)] flex-col items-stretch gap-5 text-left max-lg:w-[212px] max-lg:gap-4 max-md:w-full max-md:gap-4 max-md:mt-[40px] max-md:items-center max-md:text-center">
          ...
          <p className="w-full max-w-[336px] font-[family-name:var(--font-roboto)] text-[clamp(0.875rem,1.04vw,1.25rem)] font-medium leading-none tracking-[-0.6px] text-[#4F5E4A] opacity-85 max-lg:max-w-none max-lg:text-sm max-lg:tracking-[-0.42px] max-md:w-full max-md:text-sm">
            {t.hero.description}
          </p>

          <button className="flex h-[45px] w-full max-w-[336px] cursor-pointer items-center justify-center bg-[#4F5E4A] font-[family-name:var(--font-roboto)] text-[clamp(0.875rem,1.04vw,1.25rem)] font-medium leading-none tracking-[-0.6px] text-[#F0EAE2] transition-colors hover:bg-[#6C7B67] max-lg:w-[212px] max-lg:h-[30px] max-lg:text-sm max-lg:tracking-[-0.42px] max-md:w-full max-md:max-w-none max-md:h-[45px] max-md:text-sm">
            {t.hero.cta}
          </button>
        </div>
      </div>
